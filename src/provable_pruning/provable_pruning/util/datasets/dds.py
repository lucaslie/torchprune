...
class DownloadDataset(data.Dataset, ABC):
    ...
    def _download_url(self):
        if "DATA_DOWNLOAD_SERVER" in os.environ:
            return os.environ.get("DATA_DOWNLOAD_SERVER")
        return "https://this.url.does.not.exist.com/"
    ...
    def __init__(
        ...
        """
        # expand the root to the full path
        self._root = os.path.realpath(root)

        # expand data_dir to the full path
